...
menuConnectionPage = Page("Type de connexion")
menuConnectionPage.append_item(search)
# menuConnectionPage.append_item(connectionPage)
menuConnectionPage.append_item(creationUserPage)
