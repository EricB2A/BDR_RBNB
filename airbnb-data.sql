...
VALUES
    ...
    ((SELECT adresse_id from personne WHERE id = 12), "Appartement", 12, 80, 5, "Grand appartement pour fetes", 103.33, 60.0),
    ((SELECT adresse_id from personne WHERE id = 15), "Appartement", 15, 54, 3, "Appartement typique", 35.00, 35.0),
    ((SELECT adresse_id from personne WHERE id = 21), "Villa", 21, 240, 8, "Tres grande villa pour vacances de reves", 350.00, 600.0),
